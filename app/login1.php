        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <!-- Nested Row within Card Body -->
                ...
                <div class="p-5">
                  ...
                  <img src="img/logo.png" class="mb-2 mt-0" style="padding:0 0 0 9px; float:left;  width: 90px;">
                    <h1 class="h4 text-gray-900 mb-4">Sistem Informasi Akses Kontrol Keamanan Sekolah Vokasi UNPAK <br>Login</h1>
                  </div>
                  <form class="user" action="proses-login1.php" method="post">
