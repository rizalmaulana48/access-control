...
<div class="card mt">
  ...
  <div class="card-body mb-1">
    <h4>Daftar Mahasiswa Sekolah Vokasi UNPAK</h4>
    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-right">
          <li><a class="dropdown-item" href="mahasiswa-smt1-tu.php"> Semester 1</a>
          <li><a class="dropdown-item" href="mahasiswa-smt2-tu.php"> Semester 2</a>
          <li><a class="dropdown-item" href="mahasiswa-smt3-tu.php"> Semester 3</a>
          <li><a class="dropdown-item" href="mahasiswa-smt4-tu.php"> Semester 4</a>
          <li><a class="dropdown-item" href="mahasiswa-smt5-tu.php"> Semester 5</a>
          <li><a class="dropdown-item" href="mahasiswa-smt6-kalab.php"> Semester 6</a>   
      </li>
      </ul>
      </li>
      </ul>
    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle text-primary" href="#" data-toggle="dropdown">Prodi Sekolah Vokasi- Teknik Komputer</a>
          ...
          <li><a class="dropdown-item" href="mahasiswa-smt4-tu.php"> Semester 4</a>
          <li><a class="dropdown-item" href="mahasiswa-smt5-tu.php"> Semester 5</a>
          <li><a class="dropdown-item" href="mahasiswa-smt6-tk-kalab.php"> Semester 6</a>   
        </li>
      </ul>
    </li>
  </ul>
